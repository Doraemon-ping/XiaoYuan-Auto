...
def get_device_resolution():
    result = subprocess.run(["D:\\adb\\platform-tools\\adb.exe", "shell", "wm", "size"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
def run_adb_command(commands):
    ...
    for command in commands:
        result = subprocess.run(["D:\\adb\\platform-tools\\adb.exe", "shell", command], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
